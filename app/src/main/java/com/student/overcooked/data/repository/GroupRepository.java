...
import com.student.overcooked.data.repository.group.GroupInfoDataSource;
import com.student.overcooked.data.repository.group.GroupInvitationDataSource;
import com.student.overcooked.data.repository.group.GroupMemberDataSource;
...
public class GroupRepository {
    ...
    public void approveMember(String memberId, OnSuccessListener<Void> onSuccess, OnFailureListener onFailure) {
        groupMemberDataSource.approveMember(memberId, onSuccess, onFailure);
    }

    public void rejectMember(String groupId, String memberId, OnSuccessListener<Void> onSuccess, OnFailureListener onFailure) {
        groupMemberDataSource.rejectMember(groupId, memberId, onSuccess, onFailure);
    }
}
