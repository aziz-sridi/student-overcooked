...
public class SignupActivity extends AppCompatActivity {
    ...
    private void signup() {
        ...
        signupButton.setText(R.string.signup_in_progress);
    ...
    private void openEmailVerificationScreen(@Nullable String email) {
