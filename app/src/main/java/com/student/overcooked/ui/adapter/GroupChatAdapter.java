...
public class GroupChatAdapter extends ListAdapter<GroupMessage, RecyclerView.ViewHolder> {
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(GroupMessage message) {
            String senderNameStr = message.getSenderName() != null ? message.getSenderName() : "Unknown";
            if (senderName != null) {
                senderName.setText(senderNameStr);
                senderName.setVisibility(View.VISIBLE);
            }
            messageText.setText(message.getMessage());
            if (message.getTimestamp() != null && timeText != null) {
                timeText.setText(timeFormat.format(message.getTimestamp()));
            }

            // Bind initials
            String[] parts = senderNameStr.split(" ");
            ...
            if (senderInitials != null) {
                senderInitials.setText(initials.length() > 0 ? initials.toString() : "?");
            }
        }
    }
}
