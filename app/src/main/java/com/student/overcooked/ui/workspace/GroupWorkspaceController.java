...
public class GroupWorkspaceController {
    ...
    private void uploadWorkspaceFileThenSave(ProjectResourceType type, String title, String content,
        ...
        android.util.Log.d("WorkspaceUpload", "Starting file upload: " + storagePath);
        android.util.Log.d("WorkspaceUpload", "File URI: " + fileUri);
        
        storageReference.putFile(fileUri)
                .addOnSuccessListener(taskSnapshot -> {
                    android.util.Log.d("WorkspaceUpload", "Upload succeeded, getting download URL");
                    storageReference.getDownloadUrl()
                            ...
                            .addOnFailureListener(e -> {
                                android.util.Log.e("WorkspaceUpload", "Failed to get download URL: " + e.getMessage(), e);
                                handleWorkspaceUploadFailure(saveButton, defaultButtonText);
                            });
                })
                .addOnFailureListener(e -> {
                    android.util.Log.e("WorkspaceUpload", "Upload failed: " + e.getMessage(), e);
                    handleWorkspaceUploadFailure(saveButton, defaultButtonText);
                });
    }
